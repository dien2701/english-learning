...
import { listeningService, topicService } from '../../services/contentService';
...
const STATUS_OPTIONS = [
  ...
  { value: 'NOT_COMPLETED', labelKey: 'listening.notCompleted' },
  { value: 'COMPLETED', labelKey: 'listening.completed' },
];
  ...
  return (
    <div className="mx-auto w-full max-w-content px-4 py-6 sm:px-6 lg:px-8">
      ...
      <FilterBar
        ...
        searchPlaceholderKey="listening.searchPlaceholder"
        sortable
      />

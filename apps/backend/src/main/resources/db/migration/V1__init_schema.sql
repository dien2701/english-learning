...
CREATE TABLE password_reset_tokens (
    id          BINARY(16)   NOT NULL DEFAULT (UUID_TO_BIN(UUID())),
    user_id     BINARY(16)   NOT NULL,
    token_hash  VARCHAR(64)  NOT NULL COMMENT 'HMAC-SHA256 hex của mã OTP 6 số gửi qua email (khoá RESET_CODE_SECRET, băm kèm user_id); không lưu mã thô',
    expires_at  DATETIME(6)  NOT NULL,
    ...
    CONSTRAINT chk_password_reset_tokens_attempts CHECK (attempts BETWEEN 0 AND 10)
) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci;

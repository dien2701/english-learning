...
/** {@code status}: NOT_TAKEN hoặc COMPLETED (không lưu trạng thái làm dở). */
@JsonInclude(JsonInclude.Include.NON_NULL)
public record ExamSummaryResponse(UUID id, L10n title, L10n description, List<Skill> skills, Level level,

...
1. **Đọc file `AGENTS.md`**: Để nắm bắt bắt buộc Stack công nghệ của dự án (VD: Node.js, Express, Redis, RabbitMQ...) và các quy tắc lập trình cốt lõi. BẠN BỊ CẤM đề xuất các công nghệ nằm ngoài danh sách này.

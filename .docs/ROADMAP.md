...
| 2 | Bộ máy làm bài: Nghe, Đọc, Kiểm tra | 0 | [ ] |
...
| 2a | 2 | BE service chấm điểm chung + lưu `PracticeAttempt`/`Answer`, test | Sonnet | high | [ ] |
| 2b | 2 | BE endpoint Nghe/Đọc/Kiểm tra, ẩn đáp án, lịch sử, `study_sessions`, test 403/lộ đáp án | Sonnet | medium | [ ] |
| 2c | 2 | FE: bỏ mock `listening,reading,exams,attempts`, sửa kiểu | Sonnet | low | [ ] |
| 2z | 2 | Đóng đợt | Haiku | low | [ ] |
